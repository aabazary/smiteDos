...
export const SMITE_GODS: God[] = [
  ...
  { name: 'Artio', role: 'Guardian', pantheon: 'Celtic' },
  ...
  { name: 'Da Ji', role: 'Assassin', pantheon: 'Chinese' },
  { name: 'Danzaburou', role: 'Hunter', pantheon: 'Japanese' },
  { name: 'Discordia', role: 'Mage', pantheon: 'Roman' },
  ...
  {name: 'Nut', role: 'Guardian', pantheon: 'Egyptian' },
